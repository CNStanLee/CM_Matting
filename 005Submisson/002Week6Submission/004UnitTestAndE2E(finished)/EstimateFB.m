% Linted
function [F, B] = EstimateFB(a, b, alpha, invcoF, invcoB, oriVar, ...
    Fmean, Bmean, unknownImg)
    % Estimates the foreground and background colors for a pixel based
    % on the
    ...
    %   invcoF, invcoB - The inverse covariance matrices for the
    % foreground and background.
    %   oriVar - The variance of the original image used in 
    ...
    % fprintf('Estimated Foreground: [%f, %f, %f], 
    % Estimated Background: [%f, %f, %f]\n', F, B);
end