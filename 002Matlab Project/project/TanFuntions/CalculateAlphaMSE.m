...
function mse = CalculateAlphaMSE(predictedAlphaFile, groundTruthAlphaFile)
    ...
    %CALCULATEALPHAMSE Calculates the Mean Squared Error between 
    % the predicted alpha matte and the ground truth alpha 
    % matte from image files.
    
    %
    
    % Inputs:
    
    %   predictedAlphaFile - The file path to the alpha matte 
    % generated by the matting algorithm.
    
    %   groundTruthAlphaFile - The file path to the ground truth 
    % alpha matte image.
    ...
    %   mse - The Mean Squared Error between the predicted and ground
    % truth alpha mattes.
